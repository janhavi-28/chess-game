...
import { Mail, Lock, LogIn, UserPlus, Github, X } from 'lucide-react';
      ...
      <div className="border-b border-zinc-800 p-6 text-center">
        ...
        <div className="p-6">
          ...
          <div className="mb-6 space-y-3">
            <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-zinc-900 transition-colors hover:bg-zinc-200">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-emerald-500">
              {isLogin ? (
                <>
